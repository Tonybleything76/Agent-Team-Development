...
contract = AgentContract(
    ...
    instruction="Write PRDs, stories, prioritize backlog, define acceptance criteria."
)

async def main():
    app = MCPApp(name="product_manager_agent")
    configure_app(app)
    async with app.run():
        ...
        async with mcp_agent:
            ...
            output = (
              ...
              "Body: draft output for product_manager_agent.\n"
            ...
            log_run({"agent":"product_manager_agent","artifact":path,"ok":ok,"issues":issues})
            print(path)
