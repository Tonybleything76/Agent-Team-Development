...
contract = AgentContract(
    name="ea_agent",
    instruction="Agenda packets, follow-ups, travel logistics, meeting summaries."
)

async def main():
    app = MCPApp(name="ea_agent")
    configure_app(app)
    async with app.run():
        ...
        async with mcp_agent:
            ...
            output = (
              ...
              "Body: draft output for ea_agent.\n"
            ...
            log_run({"agent":"ea_agent","artifact":path,"ok":ok,"issues":issues})
            print(path)
