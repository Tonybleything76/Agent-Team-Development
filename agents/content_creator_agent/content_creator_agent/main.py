...
contract = AgentContract(
    ...
    instruction="Draft long-form content + social derivatives; include objective, citations, risks, next steps."
)

async def main():
    app = MCPApp(name="content_creator_agent")
    configure_app(app)
    async with app.run():
        ...
        async with mcp_agent:
            ...
            output = (
              ...
              "Body: draft output for content_creator_agent.\n"
            ...
            log_run({"agent":"content_creator_agent","artifact":path,"ok":ok,"issues":issues})
            print(path)
