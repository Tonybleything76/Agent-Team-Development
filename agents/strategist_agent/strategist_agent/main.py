...
contract = AgentContract(
    ...
    instruction="Map current→future state, create roadmap and ROI model; align to business goals."
)

async def main():
    app = MCPApp(name="strategist_agent")
    configure_app(app)
    async with app.run():
        ...
        async with mcp_agent:
            ...
            output = (
              ...
              "Body: draft output for strategist_agent.\n"
            ...
            log_run({"agent":"strategist_agent","artifact":path,"ok":ok,"issues":issues})
            print(path)
