...
contract = AgentContract(
    ...
    instruction="Define KPIs, run baselines and A/Bs, create dashboards and cost models."
)

async def main():
    app = MCPApp(name="data_scientist_agent")
    configure_app(app)
    async with app.run():
        ...
        async with mcp_agent:
            ...
            output = (
              ...
              "Body: draft output for data_scientist_agent.\n"
            ...
            log_run({"agent":"data_scientist_agent","artifact":path,"ok":ok,"issues":issues})
            print(path)
