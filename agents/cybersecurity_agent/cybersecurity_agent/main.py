...
contract = AgentContract(
    ...
    instruction="Threat modeling, key management, policy enforcement, vendor review."
)

async def main():
    app = MCPApp(name="cybersecurity_agent")
    configure_app(app)
    async with app.run():
        ...
        async with mcp_agent:
            ...
            output = (
              ...
              "Body: draft output for cybersecurity_agent.\n"
            ...
            log_run({"agent":"cybersecurity_agent","artifact":path,"ok":ok,"issues":issues})
            print(path)
